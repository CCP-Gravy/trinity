...
const Be::ClassInfo* EveSwarm::ExposeToBlue()
{
    EXPOSURE_BEGIN( EveSwarm, "" )
		...
		MAP_ATTRIBUTE( "maxDistance", m_behavior.m_maxDistance, ":jessica-group: Swarm", Be::READWRITE | Be::PERSIST )
		...
		MAP_ATTRIBUTE( "weightParentVelocity", m_behavior.m_weightParentVelocity, ":jessica-group: Behavior", Be::READWRITE | Be::PERSIST )
		MAP_ATTRIBUTE( "weightParentAcceleration", m_behavior.m_weightParentAcceleration, ":jessica-group: Behavior", Be::READWRITE | Be::PERSIST )
