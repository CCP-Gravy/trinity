...
EveChildModifierBillboard::EveChildModifierBillboard( IRoot* lockobj )
{
}

EveChildModifierBillboard::~EveChildModifierBillboard()
{
}

Matrix EveChildModifierBillboard::ApplyTransform( const Matrix& transform ) const
{
